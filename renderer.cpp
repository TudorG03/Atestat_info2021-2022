...
draw_rect(float x, float y, float half_size_x, float half_size_y, u32 color)
{
	...
	//Convertim in pixeli pentru a se pastra aspect ratio-ul dreptunghiului in raport cu fereastra atunci cand ii modificam marimea
